      ...
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-content">
            <div class="card-body">
              <?php
              $query = "SELECT product_id, product_name, SUM(product_quantity) AS total_quantity, DATE_FORMAT(DATE_ADD(product_date, INTERVAL 543 YEAR), '%M-%Y') AS product_date
FROM tb_product 
GROUP BY DATE_FORMAT(product_date, '%m%')
                ...
                <script>
                  ...
                  var myChart = new Chart(ctx, {
                    ...
                    data: {
                      ...
                      datasets: [{
                        label: 'รายงานจำนวนสินค้าคงเหลือ แยกตามเดือน',
                        data: [<?php echo $total; ?>],
                        backgroundColor: [
                          'rgba(255, 99, 132, 0.2)',
                          'rgba(54, 162, 235, 0.2)',
