...
<?php
	$total=0;
	foreach($_SESSION['shopping_cart'] as $p_id=>$qty)
	{
...
<tr>
    ...
    <td><input name="name" type="text" id="name" autocomplete="off" required/></td>
</tr>
<tr>
    <td width="22%" bgcolor="#EEEEEE">ที่อยู่</td>
    <td width="78%">
    <textarea name="address" cols="35" rows="5" id="address" autocomplete="off" required></textarea>
    </td>
</tr>
<tr>
  	<td bgcolor="#EEEEEE">อีเมล</td>
  	<td><input name="email" type="email" id="email" autocomplete="off" required/></td>
</tr>
<tr>
  	<td bgcolor="#EEEEEE">เบอร์ติดต่อ</td>
  	<td><input name="phone" type="text" id="phone" autocomplete="off" required /></td>
</tr>
<tr>
