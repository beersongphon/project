<?php
	...
	if(!empty($_POST["search"]["post_at"])) {			
		...
		$queryCondition .= "WHERE tb_order.order_date BETWEEN '$fiy-$fim-$fid' AND '" . $post_at_todate . "'";
	}
	...
	tb_order_detail
	ON
	tb_order_detail.order_id = tb_order_detail.order_id " . $queryCondition . " ORDER BY tb_order.order_id desc";
