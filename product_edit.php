              ...
              ?>
                  <form method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" id="product_quantity" name="product_quantity" placeholder="จำนวน" class="form-control" value="<?php echo $row["product_quantity"]; ?>">
                    </div>
                    <div class="form-group">
                      <label for="product_description" class=" form-control-label">รายละเอียดสินค้า</label>
                      <input type="text" id="product_description" name="product_description" placeholder="รายละเอียดสินค้า" class="form-control" value="<?php echo $row["product_description"]; ?>">
                    </div>
