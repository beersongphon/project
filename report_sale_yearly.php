...
if(ISSET($_POST['search'])){
  $date1 = date("Y", strtotime($_POST['date1']));
  $date2 = date("Y", strtotime($_POST['date2']));
}
            ...
            <div class="card-body">
              <form class="table-data__tool-right input-group" method="post" action="<?php echo $_SERVER["SCRIPT_NAME"]; ?>">
                <div class="input-group mb-3">
                  ...
                  <input type="text" class="form-control" placeholder="Start" name="date1"/>
                  <label class="input-group-text">ถึง</label>
                  <input type="text" class="form-control" placeholder="End"  name="date2" />
