    ...
    <div class="sidebar-wrapper active">
      ...
      <div class="sidebar-menu">
        <ul class="menu">
          ...
          <li class="sidebar-item <?= (basename($_SERVER['PHP_SELF']) == "product_add.php") ? "active" : ""; ?>">
          ...
          <li class="sidebar-item  <?= (basename($_SERVER['PHP_SELF']) == "product_edit.php") ? "active" : ""; ?>">
            <a href="./product_edit.php" class='sidebar-link'>
